            ...
            <div class="col-10">
                <table id="cart" class="table table-hover table-condensed">
                        ...
                        <tr>
                            <td data-th="Product">
                                <div class="row d-flex flex-wrap">
                                    <div class="col-sm-2 hidden-xs"><img src="https://product.hstatic.net/1000306633/product/crayon_wolf_tee_b_4d3af1e1114e42758a75fab5bc1af277_grande.jpg" alt="Sản phẩm 1" class="img-responsive" width="100">
                                    </div>
                                    <div class="col-sm-10">
                                        <h5 class="nomargin">Sản phẩm 1</h5>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td><a href="sanpham.html" class="btn btn-warning"><i class="fa fa-angle-left"></i> Tiếp tục mua hàng</a>
                            </td>
                            <td colspan="2" class="hidden-xs"> </td>
                            <td class="hidden-xs text-center"><strong>Tổng tiền 500.000 đ</strong>
                            </td>
                            <td><a href="dangnhap.html" class="btn btn-success btn-block">Thanh toán<i class="fa fa-angle-right"></i></a>
                            </td>
                        </tr>
                    </tfoot>
                </table>
